...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li><a href="index.html"><i class="icon icon-home"></i> <span>----Магазин</span></a> </li>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Лодки</span></a> </li>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Аксесуари Kolibri</span></a> </li>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Аксесуари Borika</span></a> </li>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Замовлення</span><span class="label label-important">4</span></a> </li>

    <li><a href="index.html"><i class="icon icon-home"></i> <span>----Блог</span></a> </li>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Коментарі</span></a> </li>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Всі записи</span></a> </li>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Додати новий запис</span></a> </li>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Категорії</span></a> </li>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Теги</span></a> </li>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Медіафайли</span></a> </li>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Окремі сторінки</span></a> </li>
