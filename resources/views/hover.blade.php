...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" href="{{('/')}}public/hover/css/normalize.css" />
		<link rel="stylesheet" type="text/css" href="{{('/')}}public/hover/css/demo.css" />  
		<link rel="stylesheet" type="text/css" href="{{('/')}}public/hover/css/set2.css" />
		<!-- <link rel="stylesheet" type="text/css" href="{{('/')}}public/hover/fonts/font-awesome-4.2.0/css/font-awesome.min.css" />  -->
		<!--[if IE]>
			...
			<div class="content">
				...
				<div class="grid">
					<figure class="effect-steve">
						<img src="{{('/')}}public/hover/img/29.jpg" alt="img29"/>
						<figcaption>
					...
					<figure class="effect-steve">
						<img src="{{('/')}}public/hover/img/33.jpg" alt="img33"/>
						<figcaption>
							<h2>Lonely <span>Steve</span></h2>
							<p>Steve was afraid of the Boogieman.</p>
							<a href="#">View more</a>
